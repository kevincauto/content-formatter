...
export default class HTML extends React.Component{
  ...
  render(){
        ...
        let html = `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
        <html>
        <head>
        ...
        htmlBody = htmlBody.substring(htmlBody.lastIndexOf("<body>")+6,htmlBody.lastIndexOf("</body>"));
        htmlBody = htmlBody.replace(/ class="p1"/g, '');
        htmlBody = htmlBody.replace(/ class="p2"/g, '');
        htmlBody = htmlBody.replace(/ class="p3"/g, '');
        htmlBody = htmlBody.replace(/ class="p4"/g, '');
        htmlBody = htmlBody.replace(/ class="p5"/g, '');
        htmlBody = htmlBody.replace(/ class="p6"/g, '');
        htmlBody = htmlBody.replace(/ class="p7"/g, '');
        htmlBody = htmlBody.replace(/ class="p8"/g, '');
        htmlBody = htmlBody.replace(/ class="p9"/g, '');
        htmlBody = htmlBody.replace(/ class="p10"/g, '');
        htmlBody = htmlBody.replace(/ class="p11"/g, '');
        htmlBody = htmlBody.replace(/ class="p12"/g, '');
        htmlBody = htmlBody.replace(/<\/p>/g, '<\/p>\n');
        htmlBody = htmlBody.replace(/<span class="s1">/g, '');
        htmlBody = htmlBody.replace(/<span class="s2">/g, '');
        htmlBody = htmlBody.replace(/<span class="s3">/g, '');
        htmlBody = htmlBody.replace(/<span class="s4">/g, '');
        htmlBody = htmlBody.replace(/<span class="s5">/g, '');
        htmlBody = htmlBody.replace(/<span class="s6">/g, '');
        htmlBody = htmlBody.replace(/<span class="s7">/g, '');
        htmlBody = htmlBody.replace(/<span class="s8">/g, '');
        htmlBody = htmlBody.replace(/<span class="s9">/g, '');
    ...
    html =`${htmlTitle}${htmlDeck}${htmlAuthor}${htmlBody}`
